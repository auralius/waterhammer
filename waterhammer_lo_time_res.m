% This function return p_data, which is a 11xM matrix. 
% Simulation runs for 10 seconds, sampled at 0.00001s.
% Data is only logged after every 1 sec.
%
...
%
% As for the row, there are 11  rows:
% The first row is the pressure taken at t = 0;
% The second row is the pressure taken at t = 1;
% The eleventh row is the pressure taken at t = 10;
%
...
%
function [t, l, p_data] = waterhammer_lo_time_res(tau)
